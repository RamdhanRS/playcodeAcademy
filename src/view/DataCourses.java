 ...
 * @author ramdh
 */
public class DataCourses extends javax.swing.JDialog {
    ...
    public CoursesModel coursesModel = new CoursesModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataCourses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataCourses dialog = new DataCourses(new javax.swing.JFrame(), true);
    ...
    private void searching() {
        List<CoursesModel> list = coursesService.searching(txtSearch.getText());
    ...
    private void selectedData() {
        ...
        coursesModel.setCourseName(tblCourses.getModel().getValueAt(row, 2).toString());
        dispose();
    }
}
