...
public class DataStudent extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataStudent dialog = new DataStudent(new javax.swing.JFrame(), true);
    ...
    private void searching() {
        List<UserModel> list = userService.searching(txtSearch.getText());
    ...
    private void selectedData() {
        ...
        userModel.setId((int) tblStudent.getModel().getValueAt(row, 0));
        userModel.setNama(tblStudent.getModel().getValueAt(row, 2).toString());
        dispose();
    }
}
